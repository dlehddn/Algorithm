package DFSBFS.백준14442번_벽부수고이동하기2;
...
public class Resolve {
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (map[nY][nX] == 0 && !visited[nY][nX][poll.boomCnt]) {
                    ...
                    q.add(new Block(nY, nX, poll.goCnt + 1, poll.boomCnt));
                }
                if (map[nY][nX] == 1 && poll.boomCnt < K && !visited[nY][nX][poll.boomCnt + 1]) {
                    visited[nY][nX][poll.boomCnt + 1] = true;
                    q.add(new Block(nY, nX, poll.goCnt + 1, poll.boomCnt + 1));
                }
            }
    ...
    static class Block {
        ...
        public Block(int y, int x, int goCnt, int boomCnt) {
            this.y = y;
            this.x = x;
            this.goCnt = goCnt;
